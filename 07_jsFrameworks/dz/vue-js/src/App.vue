<template>
  ...
  <div class="background-color-layer" style="background-image: url('/components/assets/images/img-01.jpg')">
...
/*.form_body::after{
  ...
  width:100%;
  height: 100%;
  background: rgba(255, 255, 255, 0.9) url("assets/images/loading.gif") center / 50px no-repeat;
  opacity:0;
  visibility:hidden;
...
.h1 .small,.h1 small,.h2 .small,.h2 small,.h3 .small,.h3 small,.h4 .small,.h4 small,.h5 .small,.h5 small,.h6 .small,.h6 small,h1 .small,h1 small,h2 .small,h2 small,h3 .small,
...
.bg-success {
  background-color: #87e329;
}
a.bg-success:focus,
a.bg-success:hover {
  background-color: #6dc019;
}
.bg-info {
...
body {
  background-image: -webkit-linear-gradient(top, #00bfff, #81D4FA);
  background-image: -o-linear-gradient(top, #00bfff 0, #81D4FA 100%);
  background-image: linear-gradient(180deg, #00bfff 0, #81D4FA);
  background-repeat: repeat-x;
...
.background-color-layer {
  ...
  right: 0;
  bottom: 30%;
  box-shadow: inset 0 -40px 60px 10px #00bfff;
}
.card {
...
.btn-info,
.btn-info:hover {
  background-image: -webkit-linear-gradient(left, #f7981c, #f76b1c);
  background-image: -o-linear-gradient(left, #f7981c 0, #f76b1c 100%);
  background-image: linear-gradient(90deg, #f7981c 0, #f76b1c);
  background-repeat: repeat-x;
  filter: progid:DXImageTransform.Microsoft.gradient(startColorstr="#FFF7981C",endColorstr="#FFF76B1C",GradientType=1);
}
.btn-info:hover {
  background-position: 50%;
}
...
/*# sourceMappingURL=main.bc58148c.map*/
